...
import com.yuanjin.attorney.attorney.adapter.Case_case_Adapter;
...
public class Case_CaseFragment extends BaseFragment implements PullToRefreshListener {

    private SwipeRefreshLayout        mRefreshLayout;
    private RecyclerView              mRecycleView;
    private int                       mLastVisibleItemPosition;
    private PullToRefreshRecyclerView mPullToRefresh;
    private Case_case_Adapter mCase_case_adapter = new Case_case_Adapter(getContext());

    @Override
    protected View createSuccessView() {
        View view = View.inflate(getContext(), R.layout.view_case_case, null);
        init(view);
        return view;
    }
...
//        mPullToRefresh.addItemDecoration(new RecycleViewDivider(getContext(),LinearLayoutManager.VERTICAL,10,getResources().getColor(R.color.color_red)));
        ...
        mPullToRefresh.setAdapter(mCase_case_adapter);
